...
class blok
{
    ...
    public:
		...
		void Podziel_na_pol(blok & L, blok & R, int ile_bitow = 64);			//blok L przejmuje lewą część słowa, blok R - prawą, domyślnie bitów jest 64 ale można o tym zdecydować
		void Polacz_polowy(blok L, blok R, int nowa_dlugosc);										// Laczy dwie polowy w jednym bloku, wprowadzamy dlugosc powstalego słowa
